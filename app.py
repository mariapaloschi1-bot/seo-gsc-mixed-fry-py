    ...
    if st.session_state.countries_data is not None:
        ...
        **Visualizzazione mercati geografici con CTR basso ma alto volume di impressioni.**  
        ...
        if not opportunity_markets.empty:
            ...
            st.markdown("#### 🌐 Bubble Chart: Impressioni vs CTR per Paese")
            st.markdown("*Dimensione bolla = Clic totali. Colore = CTR (rosso basso → verde alto). Solo paesi con >10K impressioni e CTR <2%.*")
